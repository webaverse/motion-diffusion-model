...
try:
    ...
    if platform.system() == 'Windows' or platform.system() == 'Microsoft':
        ...
        print('For example: cp ../../lib/Python37_x64/* /Library/Frameworks/Python.framework/Versions/2.7/lib/python2.7/site-packages')
...
class FbxReadWrite(object):
    ...
    def writeFbx(self, basePath):
        lResult = SaveScene(self.lSdkManager, self.lScene, basePath + "/output.fbx")

        if lResult == False:
            raise Exception("Failed to write to {}".format(basePath))
